...
plt.semilogx(v_rel_arr, drags, color="k", linewidth=3, label="Drag")
plt.semilogx(v_rel_arr, sputs, color="k", linestyle="--", linewidth=3, label="Sputtering (Si)")
plt.xlabel(r"$v_{rel}~[km\,s^{-1}]$")
plt.ylabel(r"$t~[Myr]$")
plt.xlim(2e1, 1e5)
plt.ylim(-0.1, 4)
...
fig, ax = plt.subplots(figsize=(12,8))
ax.ticklabel_format(axis="y", style="sci")
plt.semilogx(n_arr, drags, color="k", linewidth=3, label="Drag")
plt.semilogx(n_arr, sputs, color="k", linestyle="--", linewidth=3, label="Sputtering (Si)")
plt.xlabel(r"$n~[cm^{-3}]$")
plt.ylabel(r"$t~[Myr]$")
#plt.xlim(1e1, np.amax(yield_Si))
#lt.ylim(-5, 100)
...
fig, ax = plt.subplots(figsize=(12,8))
ax.ticklabel_format(axis="y", style="sci")
plt.semilogx(a_arr, drags, color="k", linewidth=3, label="Drag")
plt.semilogx(a_arr, sputs, color="k", linestyle="--", linewidth=3, label="Sputtering (Si)")
plt.xlabel(r"$a~[\mu m]$")
plt.ylabel(r"$t~[Myr]$")
#plt.xlim(1e1, np.amax(yield_Si))
#lt.ylim(-5, 100)
