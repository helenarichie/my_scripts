...
for i in range(ns, ne+1):
    ...
    # plot
    fig, ax = plt.subplots(nrows=2, ncols=2, figsize=(22.65,9), gridspec_kw={"width_ratios":[1.75, 7], 'wspace':0, 'hspace':0})
    ...
    ax[1][0].set_ylabel(r"$m_{dust}/m_{dust,i}$", labelpad=10)
    ax[0][0].set_ylabel(r"$m_{cl}/m_{cl,i}$", labelpad=10)
    ax[1][0].set_xlabel("Time [Myr]", labelpad=10)
